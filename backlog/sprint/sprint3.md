...
Make the starter practical to keep: optimized media, accessibility and contrast checks, broader test coverage,
lint/format hooks, article generation, onboarding, 404 handling, and merge-check guidance.
