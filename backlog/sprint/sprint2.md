...
Turn the vertical slice into a deployable catalogue: article navigation, related discovery, static search, tag browsing,
SEO artifacts, CI checks, and GitHub Pages deployment.
