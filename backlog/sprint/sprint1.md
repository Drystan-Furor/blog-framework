...
Create the smallest useful Astro starter path: documented structure, architecture decisions, Markdown Hello World article, static article route, responsive index grid, system theme, and first Playwright smoke coverage.
