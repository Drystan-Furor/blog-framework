...
Before implementing:
- Refine the problem statement. Ask for clarification.
- draft a spec-driven story.
- if the spec driven story cannot be 100% achieved, ask questions.
- State your assumptions explicitly. If uncertain, ask.
- Always ask questions to refine the spec driven story untill you can 100% execute the task.
...
- Use the "master" branch as a starting point.
- When finished, commit with a descriptive industry grade message.
- Test Driven Development - TDD, Set up tests first, then cret
